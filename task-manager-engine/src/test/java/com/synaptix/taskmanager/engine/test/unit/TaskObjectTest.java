...
public class TaskObjectTest {
    ...
    public void test6() {
        ITaskObjectManager<String, BusinessObject> taskObjectManager = TaskObjectManagerBuilder.<String, BusinessObject>newBuilder(BusinessObject.class).addTaskChainCriteria(null, "A", "VERSA->VERSB")
                .addTaskChainCriteria("B", "C", "VERSC").build();
        ITaskObjectManager<String, OtherBusinessObject> otherTaskObjectManager = TaskObjectManagerBuilder.<String, OtherBusinessObject>newBuilder(OtherBusinessObject.class)
                .addTaskChainCriteria(null, "A", "VERSA->VERSB").build();
    ...
    @Test
    public void test7() {
        ITaskObjectManager<String, BusinessObject> taskObjectManager = TaskObjectManagerBuilder.<String, BusinessObject>newBuilder(BusinessObject.class).statusGraphs(
                StatusGraphsBuilder.<String>newBuilder().addNextStatusGraph("A", "ATask", StatusGraphsBuilder.<String>newBuilder()

package com.talanlabs.taskmanager.jpa.test.it;
...
import com.talanlabs.taskmanager.jpa.test.data.BusinessObject;
import com.talanlabs.taskmanager.jpa.test.data.ChangeCodeTaskService;
import com.talanlabs.taskmanager.jpa.test.data.JPAHelper;
import com.talanlabs.taskmanager.jpa.test.data.MultiUpdateStatusTaskService;
import com.talanlabs.taskmanager.jpa.test.data.OtherBusinessObject;
import com.talanlabs.taskmanager.jpa.test.data.StopTaskService;
import com.talanlabs.taskmanager.model.ITaskCluster;
import com.talanlabs.taskmanager.jpa.test.data.SetNowDateTaskService;
import com.talanlabs.taskmanager.jpa.test.data.VerifyCodeTaskService;
